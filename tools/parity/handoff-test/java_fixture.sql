...
--
--  ------------------------------------------------------------
--  ★이 파일에 대해 (tools/parity/handoff-test/)
--    backend-java/src/main/resources/db/90_parity_fixture.sql 의 복제본.
--    제3자에게 넘길 COBOL→Java 비교 도구 검증용 세트 — 짝이 되는
--    cobol_fixture.sql 과 값이 1군데 다르다(의도적). 어디가 다른지는
--    이 파일에는 적지 않음 — tools/parity/handoff-test/ANSWER-KEY.md
--    (본인 전용, 제3자에게 전달 금지) 참고.
--  ------------------------------------------------------------
--
...
--      4001213 普通  1건(구분3)                이자0 + 手数料合計은 0 아님
...
INSERT INTO TORIHIKI (TORIHIKI_ID,KOUZA_NO,TORIHIKI_DT,TORIHIKI_KBN,KINGAKU,AITE_KOUZA,TESURYO,TEKIYOU) VALUES
  ...
  (100000000007,4001213,'20260801140000','3', 1000,3000789, 90,NULL),
