      *>****************************************************************
      *> SHUKKIN  -  出金 CGI (オンライン 5種の1)
      *>   POST: kouza, kingaku
      *>   残高不足なら取引拒否(§5): 更新せず 409 insufficient_funds。
      *>   凍結(JOUTAI=9)口座は拒否。KOUZA.ZANDAKA -= kingaku, TORIHIKI(区分2)。
      *>****************************************************************
